...
<body>
  <div style="margin: 40px;">
    ...
    <p style="text-align: end; font-size: 12px;">Fecha: {{fecha}}</p>
    <br>
    <br>
...
<tr>
    ...
    <div>
      <div>
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td class="containerPLogo">
                <p class="inline">WinRAR
                  <img class="pLogo inline" src="http://localhost:3002/programLogo/rar.jpg" alt="WinRAR" />
                </p>
              </td>
              <td>
                {{winRARCheck}}
            ...
            <tr>
              <td class="containerPLogo">
                <p class="inline">Draw.io <img class="pLogo inline" src="http://localhost:3002/programLogo/draw.jpg"
                    alt="Draw.io" />
                </p>
              </td>
              <td>
            ...
            <tr>
              <td class="containerPLogo">
                <p class="inline">AnyDesk <img class="pLogo inline" src="http://localhost:3002/programLogo/any.jpg"
                    alt="AnyDesk" />
                </p>
              </td>
              <td>
            ...
            <tr>
              <td class="containerPLogo">
                <p class="inline">LightShot <img class="pLogo inline" src="http://localhost:3002/programLogo/lig.jpg"
                    alt="LightShot" />
                </p>
              </td>
              <td>
      ...
      <br>
      <div>
        <h1>LISTA DE SOFTWARE ADICIONAL</h1>
        {{softwareAdicional}}
      </div>
    </div>
  </div>
...
function insertarDatosDocumento(data) {
  ...
  content = content.replace("{{nombre}}", data.datosUsuarioResponsable.nombre);
  content = content.replace("{{puesto}}", data.datosUsuarioResponsable.puesto);
  content = content.replace(
    "{{ubicacion}}",
  ...
  content = content.replace("{{versionSO}}", data.arquitecturaEquipo.versionSO);
  content = content.replace(
    "{{arquitectura}}",
